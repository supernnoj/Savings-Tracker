    ...
    def __init__():
        ...
        def __start__():
            ...
            def clickCreate():
                ...
                x_coordinate = (screen_width/2)-(WIDTH/2)
                y_coordinate = (screen_height/2)-(HEIGHT/2)
                create.geometry("%dx%d+%d+%d" %(WIDTH,HEIGHT,x_coordinate,y_coordinate))
                ...
                # ========= >>> confirm button <<< ========= 
                def confirm():
                    if validate.fields(userfield.get()) or validate.fields(emailfield.get()) or validate.fields(pwfield.get()) or validate.fields(cpwfield.get()):
                        error.empty()
                    else:
                        if Q.verify_user(userfield.get()) or Q.verify_email(emailfield.get()):
                            ...
                            if pwfield.get() == cpwfield.get():
                                if Q.create_user(emailfield.get(), userfield.get(), pwfield.get()):
                                    create.destroy()
                                    success.user_added()
                            else:
                                error.password()
            ...
            def clickLogin():
                ...
                x_coordinate = (screen_width/2)-(WIDTH/2)
                y_coordinate = (screen_height/2)-(HEIGHT/2)
                login.geometry("%dx%d+%d+%d" %(WIDTH,HEIGHT,x_coordinate,y_coordinate))
                ...
                def confirm_log():
                    if validate.fields(userfield.get()) or validate.fields(pwfield.get()):
                        error.empty()
                    else:
                        print(f'')
                        ...
                        if Q.verify_user(userfield.get()) == False:
                            ...
                            print(f' password : {Q.verify_pw(userfield.get(), pwfield.get())}')
